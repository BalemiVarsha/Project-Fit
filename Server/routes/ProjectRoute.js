...
const { addProject,getProjectCount,getProjectData ,getProjectDetails,deleteProject,updateProject,getProjectByTitle,postSearch,calculateScoreController ,getProjectPdf} = require('../controllers/projectController');
const { authenticateToken } = require('../middlewares/auth');
const path = require('path');
const fs=require('fs');
const {uploadToS3,retrieveFromS3}=require('../middlewares/aws_s3')// const { postSearch } = require('..');
const setupMulter = require('../helper/multerhelper');

// Call the setupMulter function to get the multer instance
